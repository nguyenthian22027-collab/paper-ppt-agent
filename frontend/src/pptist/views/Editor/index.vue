<template>
  <div class="pptist-editor">
    ...
    <div class="layout-content">
      ...
      <div class="layout-content-center" :class="{ 'layout-content-center-expanded': toolbarCollapsed }">
      ...
      <Toolbar v-if="!toolbarCollapsed" class="layout-content-right" />
    </div>
  </div>
...
.layout-content-center-expanded {
